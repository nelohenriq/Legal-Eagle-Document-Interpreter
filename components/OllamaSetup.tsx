  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-2xl mx-auto">
      <div className="w-full bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 text-center">
        ...
        <h2 className="mt-4 text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Configurar Servidor Ollama</h2>
        <p className="mt-2 text-slate-600 dark:text-slate-400">
          Introduza o URL base do seu servidor Ollama. Será guardado de forma segura no seu browser.
        </p>
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          <div>
            <label htmlFor="ollama-url" className="sr-only">
